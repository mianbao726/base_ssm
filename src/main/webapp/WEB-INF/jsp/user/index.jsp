...
<body class="no-skin">
			...
			<div class="page-content">
				...
				<div class="page-content-area">
					<div class="page-header">
						...
						<button class="btn btn-success btn-sm" onclick = 'goadd()'><i class="fa fa-plus"></i>添加新纪录</button>
					...
					<div class="row">
						<div class="col-sm-9">
							<table id="list"
								...
								<thead>
									<tr>
										<th class="ace_choose_all" style="width: 10px"><label><span class="lbl"></span>
										</label>id</th>
										<th>姓名</th>
										<th>密码</th>
										<th>年龄</th>
	...
	$(document).ready(function() {
							...
							"columnDefs" : [
								{
									"render" : function(data, type,row) {
												return '<span class="ui-icon ace-icon fa fa-trash-o red" onclick="del(\'' + row.id+ '\')" ></span>&nbsp;&nbsp;&nbsp;&nbsp;<span class="ui-icon ace-icon fa fa-pencil blue" onclick="edit(\'' + row.id+ '\')" ></span>';
												},
									"orderable" : false,
									"targets" : 4
								} ]
		...
		$("#goAdd").click(function() {
			window.location.href = '<%=path%>/zk/developer_au.action';
		})
