...
<jsp:param name="title" value="债务拍卖管理" />
<jsp:param name="link1" value="债务拍卖管理" />
...
<script type="text/javascript">
	...
	/***新增页面跳转***/
	$("#add").click(function(){
		window.location.href = '<%=path%>/debt/au4.html';
	});
...
// 		window.location.href="ADDROLE.jsp?operate="+operate+"&id="+id;
		window.location.href = '<%=path%>/debt/au4.html?id='+id;
	}
