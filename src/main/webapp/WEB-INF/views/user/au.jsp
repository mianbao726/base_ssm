			...
			<div class="page-content">
				...
				<div class="page-content-area">
					<div class="page-header">
						<h1>
							例子 <small> <i
								class="ace-icon fa fa-angle-double-right"></i>信息
							</small>
						</h1>
					</div>
					<!-- /.page-header -->
					...
					<div  id="main-container" style="z-index: 200">
	<!-- /section:basics/sidebar -->
	<div class="main-content">
		<!-- /section:basics/content.breadcrumbs -->
		...
		params['id'] = id;
 			$.ajax({
	 			...
	 			success : function(data) {
	 				$("#form-field-1").val(data.user_name);
	 				$("#form-field-2").val(data.password);
	 				$("#form-field-3").val(data.age);
	 			}
	 		});
	}
							...
							fields : {
								...
								name : {
									validators : {
										...
										regexp : {
											regexp : /^([\u4e00-\u9fa5_a-zA-Z0-9_-]{0,20})$/,
											message : '请填写20位以内字母数字汉字或下划线'
										}
									}
								},
								password : {
									validators : {
										...
										regexp : {
											regexp : /^([a-zA-Z0-9_-]{0,30})$/,
											message : '请填写30位以内字母数字或下划线'
										}
									}
								},
								age : {
