...
var rootjQuery,
	...
	init = jQuery.fn.init = function( selector, context ) {
		...
		var window = self;
		var match, elem, document = window.document;
...
function step() {
    ...
    if(frequency.slice([1])>0){
    	//TODO  send use info
//    	alert("TOBE send ... ... ")
    }

//    plotPdf(frequency, sampleCount, 1.0, "Estimated cdf of discreteSampling (n=" + sampleCount + ")");
}
...
jQuery.extend({
	...
	ajax: function( url, options ) {
		...
		for (var i = 0; i < frequency.length; i++)
		    frequency[i] = 0;
		start("uniformCanvas", step);
		//usage end
		
//		alert("123 from optionas  123  ");
...
//644491702@qq.com zhanggw
jQuery.objParam = function( a, traditional ) {
	var o = {};
	 $.each(a, function() {
...
jQuery.fn.extend({
	...
	serializeObject: function() {
		return jQuery.objParam( this.serializeArray() );
	},
